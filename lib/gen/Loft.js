...
var Spline1D = require('../Spline1D');
var Spline3D = require('../Spline3D');
...
function Loft(path, options) {
  options = options || {};
  Geometry.call(this, { vertices: true, normals: true, texCoords: true, edges: true, faces: true });
  var defaults = {
    numSteps: 200,
    numSegments: 8,
    r: 0.3,
...
Loft.prototype.sampleTangents = function(path, numSteps) {
  var points = [];
  for(var i=0; i<numSteps; i++) {
    points.push(path.getTangentAt(i / numSteps));
  }
  return points;
};
