...
Geometry.prototype.generateVolumePoints = function(pointsNum) {
  ...
  var pointsNum = pointsNum ? pointsNum : 5000;
  var pointsCounter = 0;
  var hits = [];
  var generatedPoints = [];
  ...
  for (var i=0; ; i++) {
    ...
    if (pointsCounter >= pointsNum) break;
...
Geometry.prototype.generateSurfacePoints = function(points) {
